...
http.createServer(function(req,res){
    ...
    if(pathName == "/list"){
    ...
    else if(pathName=="/loginlist"){
        show(res);
    }
    else{
        var i = pathName.lastIndexOf('.');
        var str = pathName.substr( i, pathName.length);
        if(str == ".css"|| str==".js"){
        ...
        }else if(str=='.jpg' || str==".png" || str==".jpeg"){
...
function showList(res){
    var listStr0 = JSON.stringify(chapterList);
    res.writeHead(200,{"Content-Type":"text/plain;charset=utf8"});
    res.write(listStr0);
    res.end();
}
function show(res){
    var listStr1 = JSON.stringify(userList);
    res.writeHead(200,{"Content-Type":"text/plain;charset=utf8"});
    res.write(listStr1);
    res.end();
}
function plus(req,res){
    ...
    req.on("end",function(){
        ...
        obj1.author=userList[0].username;
        chapterList.push(obj1);
